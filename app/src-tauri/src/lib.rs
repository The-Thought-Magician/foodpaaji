...
use modules::customers::{create_customer, get_customers, get_customer, update_customer, delete_customer, add_loyalty_points, redeem_loyalty_points, get_customer_stats, get_loyalty_transactions, get_customer_segments, get_customer_analytics};
